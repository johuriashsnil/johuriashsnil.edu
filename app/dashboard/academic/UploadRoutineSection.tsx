...
export function UploadAcademicDataSection() {
    ...
    const handlePublishAcademicData = async (e: React.FormEvent) => {
        ...
        try {
            const response = await axios.post(`${BaseURL}/api/academic`, data);
        ...
        <Card
            ...
            <form className="mt-8 mb-2 w-80 max-w-screen-lg mx-auto sm:w-96">
                <div className="mb-1 flex flex-col gap-6">
                    ...
                    <Select label="Select AcademicData"
                        animate={{
                            mount: { y: 0 },
                            unmount: { y: 25 },
                    ...
                    >
                        <Option value="academicCalender">Academic Calender</Option>
                        <Option value="academicResult">Academic Result</Option>
                        <Option value="academicSyllabus">Academic Syllabus</Option>
                    </Select>
                    ...
                    <Typography placeholder=""
                        ...
                        AcademicData Description (Optional)
                    </Typography>
                    <Input
                        placeholder=""
                        onPointerEnterCapture={() => { }}
                        onPointerLeaveCapture={() => { }}
                        crossOrigin={""}
                        label="AcademicData Description"
                        onChange={(e) => {
                ...
                <Button placeholder=""
                    onPointerEnterCapture={() => { }}
                    onPointerLeaveCapture={() => { }}
                    className="mt-6" fullWidth onClick={handlePublishAcademicData}>
                    Publish AcademicData
                </Button>
            </form>
        </Card>
    );
